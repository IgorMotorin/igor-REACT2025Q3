  ...
  return (
    <main className="dark:bg-cyan-950 dark:text-white h-lvh" data-theme={theme}>
      <div className=" dark:bg-cyan-950 dark:text-white" data-theme={theme}>
        ...
        <p className="p-3">
          This task is a continuation of the state management task. In this
          task, you will implement proper data fetching and caching mechanisms
          using modern querying libraries.
        </p>
        ...
        <ul className="p-3">
          <li>
            ...
            <p>
              1.2. For Redux users: Implement RTK Query for making API
              calls{' '}
            </p>
            <p>
          ...
          <li>
            ...
            <p>
              ...
              button) that forces a new API call instead of using cached
              data{' '}
            </p>
            <p>
              All previous API calls from your application should be converted
              to use the chosen query solution
            </p>
          </li>
          <li>
            Specific Requirements: Data loading states should be visible to
            users (loading indicators) Error states should be properly handled
            and displayed to users The cached data should persist between page
            navigations
          </li>
        </ul>
